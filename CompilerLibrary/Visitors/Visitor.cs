...
namespace Cheez.Visitors
{
    ...
    public interface IVisitor<ReturnType, DataType>
    {
        ...
        ReturnType VisitGenericExpr(AstGenericExpr expr, DataType data = default);
        ...
        ReturnType VisitConstantRef(AstConstantRef expr, DataType data = default);
        ...
        ReturnType VisitImportExpr(AstImportExpr expr, DataType data = default);
    ...
    public abstract class VisitorBase<ReturnType, DataType> : IVisitor<ReturnType, DataType>
    {
        ...
        public virtual ReturnType VisitConstantRef(AstConstantRef expr, DataType data = default) => default;
        ...
        public virtual ReturnType VisitImportExpr(AstImportExpr expr, DataType data = default) => default;
