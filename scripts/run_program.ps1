...
# &"./$file$executable_file_extension" build -thread_count 1 -debug_jobs
&"./$file$executable_file_extension" build -thread_count 1
# &"./$file$executable_file_extension" compile -thread_count 1 -debug_jobs -files "../data/basic_cheez.che"
